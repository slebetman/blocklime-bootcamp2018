...
contract InputAndOutputParameters {
    ...
    uint input1;
    address input2;
    function InputAndOutputParameters(uint _inputParam1,
	 address _inputParam2) public {
       // Initialize state variables here
       input1 = _inputParam1;
       input2 = _inputParam2;
    }

    function newFunction1(uint _inputParam1)
		 public pure returns (uint _outputParam1) {
        _outputParam1 = _inputParam1 * 3;
    }

    function newFunction2(uint _inputParam1, uint _inputParam2)
